...
import { statusMeta, timeAgo, dateTime, linkKind, linkLabel, embedUrl, RATING_LABELS, youtubeThumb } from '@/lib/present';
import {
...
import type { StudyCard, TicketCard } from '@/lib/types';
...
function AppShell() {
  const {
    ...
    studies, activeStudy, tickets, activeTicket, notifications, notifTotal, historyTickets, videos,
    ...
    ticketFilter, setTicketFilter, ticketTab, setTicketTab, hist, setHist,
    closing, setClosing, ratingHover, setRatingHover,
    videoTab, setVideoTab, videoFormOpen, setVideoFormOpen, editingVideo, setEditingVideo, syncingVideos,
    compose, setCompose, coverUploading, embed, setEmbed, catManagerOpen, setCatManagerOpen,
    editingStudyId, editingComment, setEditingComment, editingMessage, setEditingMessage,
    newTicket, setNewTicket, refQuery, refResults, refSelected, refSearching,
    ...
    loadTickets, loadHistory, loadMoreNotifications, loadVideos,
    goFeed, goSaved, goTickets, goNotifications, goProfile, goVideos, openStudy, openTicket,
